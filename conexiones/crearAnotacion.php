...
$rutUsuario=$_SESSION["rut"];
 if(! $db->query("INSERT INTO `Registro` (`idRegistro`, `Registrocol`, `fechaRegistro`, `rutUsuario`) VALUES (NULL, 'anotacion creada por: {$rutProf} con cuenta: {$rut} para el Alumno: {$rutAl}', CURRENT_TIMESTAMP, '$rutUsuario');")){
     die('Ocurrio un error ejecutando el query [' . $db->error . ']');
}
$db->close();
...
<div class="container">
	<div class="alert alert-success">
	  ...
	  <strong>Ingresado</strong> Anotacion ingresada con exito.
</div>
    <br>
    <div>
        <?php
